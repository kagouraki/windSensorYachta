...
void calculationData() {
	...
	ATOMIC()
	{
		...
		if (String(actconf.windSensorType) == "Yachta"
			...
			if (i2creadyBME280 == 1
					&& String(actconf.tempSensorType) == "BME280") {
				if (String(actconf.tempUnit) == "C") {
...
//		if (abs(winddirection - winddirection_old) > maxwinddirdev
//				&& winddirection > maxwinddirdev
//				&& winddirection < 360 - maxwinddirdev) {
