...
// content += CSS();
	...
	if (String(actconf.tempSensorType) == "DS18B20") {
		...
		content +=
				F(
						"<td><input id='temp' type='text' name='wstemp' size='15' value='0'></td>");
	...
	content +=
			F(
					"<td><input id='winddir' type='text' name='wdir' size='15' value='0'></td>");
	...
	content +=
			F(
					"<td><input id='resolution' type='text' name='wdirres' size='15' value='0'></td>");
	...
	content +=
			F(
					"<td><input id='windspeed' type='text' name='wspeed' size='15' value='0'></td>");
	...
	content +=
			F(
					"<td><input id='dwspeed' type='text' name='dwspeed' size='15' value='0'></td>");
	...
	content +=
			F(
					"<td><input id='sensor1' type='text' name='wsensor1' size='15' value='0'></td>");
	...
	if (String(actconf.windSensorType) == "WiFi 1000") {
		...
		content +=
				F(
						"<td><input id='sensor2' type='text' name='wsensor2' size='15' value='0'></td>");
		...
		content +=
				F(
						"<td><input id='pcounter' type='text' name='pcounter' size='15' value='0'></td>");
		...
		content +=
				F(
						"<td><input id='time1' type='text' name='wtime1' size='15' value='0'></td>");
		...
		content +=
				F(
						"<td><input id='time2' type='text' name='wtime2' size='15' value='0'></td>");
	...
	if (String(actconf.windSensorType) == "Yachta"
		...
		content +=
				F(
						"<td><input id='magnitude' type='text' name='magnitude' size='15' value='0'></td>");
		...
		content +=
				F(
						"<td><input id='magsensor' type='text' name='magsensor' size='15' value='0'></td>");
	...
	content +=
			F(
					"<td><input id='rotspeed' type='text' name='wrotspeed' size='15' value='0'></td>");
	...
	if (String(actconf.tempSensorType) == "BME280") {
		...
		content +=
				F(
						"<td><h3>BME280 Informations<br><blink><data id='info2'></data></blink></h3></td>");
		content += F("<td></td>");
		content += F("<td></td>");
		content += F("</tr>");
		...
		content +=
				F(
						"<td><input id='atemp' type='text' name='atemp' size='15' value='0'></td>");
		...
		content +=
				F(
						"<td><input id='pres' type='text' name='pres' size='15' value='0'></td>");
		...
		content +=
				F(
						"<td><input id='hum' type='text' name='hum' size='15' value='0'></td>");
