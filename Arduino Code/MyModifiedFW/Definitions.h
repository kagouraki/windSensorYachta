...
int SendPeriod = 500;            // SendPeriod in [ms], Attention! Range is limited [500...2000]
int RedSendPeriod = 2000;         // Reduced send period [ms] when wind speed is zero, range [2000...10000]
...
volatile unsigned long icounterold = 0; // Old interrupt counter for rotation detection
...
String timeout[12] = {"1", "30", "60", "90", "120", "150", "180", "210", "240", "270", "300", "57600"};
